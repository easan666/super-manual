...
# <span class="h1-icon"><img src="/img/VR-AutoPBR.webp" alt="Custom Icon"></span>VR-AutoNode v2.1.2
## 说明
...
::: info VR-AutoNode v2.1.2 <Badge type="danger" text="更新4+" />
1. 修复Vray在C4D 2024导入材质端口连接错误的问题

:::

::: details VR-AutoNode v2.1.0<Badge type="info" text="更新11" />
1. 优化关键词配置文件
